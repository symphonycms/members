...
Frontend membership extension for Symphony CMS. This version represents `1.2RC1` which is an update to the Members extension for the upcoming Symphony 2.3. Do not use this on production sites (yet).
